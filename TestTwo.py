...
def createLibaryActions():
    ...
    p.AddToState('Secret', False, 0.05, s.Utilities)
    a.PathList.append(p)
...
#s.generateActionPaths(bf.getBranches(s))

"""


actions = createLibaryActions()
